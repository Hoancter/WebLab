                        ...
                        <div className="contact">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <p className="text">24-08-2001</p>
                                </li>
                                <li>
                                    <span className="icon"><i className="fa fa-phone" aria-hidden="true"></i></span>
                                    <a className="text" href="tel:+84941759876">0941759876</a>
                                </li>
                                <li>
                                    <span className="icon"><i className="fa fa-envelope-o" aria-hidden="true"></i></span>
                                    <a className="text" href="mailto:hoannguyen2k1hhbg@gmail.com">hoannguyen2k1hhbg@gmail.com</a>
                                </li>
                                <li>
                                    <span className="icon"><i className="fa fa-facebook-official" aria-hidden="true"></i></span>
                                    <a className="text" href="https://www.facebook.com/hoannguyen2k1hhbg/">Facebook</a>
                                </li>
                                <li>
